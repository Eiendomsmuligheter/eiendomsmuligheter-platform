  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black to-blue-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          Maximize Property Value with AI
        </motion.h1>
        <motion.p 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Enter property address for instant AI analysis..."
        ...
        >
          ...
          <p className="text-gray-300">Drag & drop floor plans or property images</p>
